...
public class DataHelper extends SQLiteOpenHelper {
    ...
    private static final String buat_tabel_barang = "CREATE TABLE IF NOT EXISTS tabel_customer(nama TEXT, alamat TEXT, telpon TEXT, produk TEXT, ukuran TEXT, jumlah INTEGER, harga INTEGER, total INTEGER)";
    private static final  String hapus_tabel = "DROP TABLE IF EXISTS buat_tabel";

    public DataHelper(Context context){
        super(context, nama_database, null, versi_database);
    }
    //eksekusi pembuatan tabel_customer
    @Override
    ...
    public ArrayList<HashMap<String, String>> cloth(){
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                hashMapCloth.put("ukuran", cursor.getString(4));
    ...
    public int update_barang(String nama, String alamat, String telpon, String produk, String ukuran, int jumlah, int harga, int total){
        SQLiteDatabase database = this.getWritableDatabase();
        ...
        recordcloth.put("ukuran", ukuran);
        recordcloth.put("jumlah", jumlah);
        recordcloth.put("harga", harga);
        recordcloth.put("total", total);
        return  database.update("tabel_customer", recordcloth, "nama= '" + nama+"'", null);
    }
    ...
    public void tambah_cloth(String xnama, String xalamat, String xtelpon, String xproduk, String xukuran, String xjumlah, String xharga, String xtotal) {
        SQLiteDatabase database = this.getWritableDatabase();
