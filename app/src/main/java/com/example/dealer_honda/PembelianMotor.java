...
public class PembelianMotor extends ListActivity {
...
//        setContentView(R.layout.activity_pembelian_baju);
        ...
        xukuran = new String[arrayListCloth.size()];
        ...
        if (arrayListCloth.size() > 0) {
            for (int i = 0; i < arrayListCloth.size(); i++) {
                ...
                String ukuran = hashMapRecordCloth.get("ukuran");
        ...
        ListAdapter adapter = new ListAdapter(getBaseContext(), xnama, xalamat, xtelpon, xproduk, xukuran, xjumlah, xharga, xtotal);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        Intent kirim = new Intent(getApplicationContext(), DetailPembelian.class);
        ...
        kirim.putExtra("ukuran", xukuran[position].toString());
    ...
    public void onBackPressed() {
        Intent intent = new Intent(PembelianMotor.this, MainActivity.class);
