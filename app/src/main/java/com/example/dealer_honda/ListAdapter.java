...
public class ListAdapter extends ArrayAdapter<String> {
    ...
    public ListAdapter(Context context,String[] nama, String[] alamat, String[] telpon, String[] produk, String[] ukuran, String[] jumlah, String[] harga, String[] total){
        super(context, R.layout.activity_pembelian_motor, nama);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.activity_pembelian_motor, parent, false);
